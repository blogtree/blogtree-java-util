...
public class JacksonUtilTest extends BaseTest {
    ...
    public void toStr() {
        ...
        String result = JacksonUtil.toStr(user);
        print(result);
    ...
    public void toObj() {
        ...
        // get class
        UserPo result = JacksonUtil.toObj(json, UserPo.class);
        print(result);
        print2Json(result);
        assert result != null;
...
//        assert "Ada".equals(newList.get(0).getName());
    ...
    public void toMap() {
        ...
        // get json
        String json = JacksonUtil.toStr(map);
        print(json);
        // {"Leon":20,"Ada":18}
        assert "{\"Leon\":20,\"Ada\":18}".equals(json);

        // get new map
        Map<String, Object> newMap = JacksonUtil.toMap(json);
        print(newMap);
        print2Json(newMap);
        assert newMap != null;
    ...
    public void toMapWithClass() {
        ...
        // get new map
        Map<String, UserPo> newMap = JacksonUtil.toMap(json, UserPo.class);
        print(newMap);
        print2Json(newMap);
        assert newMap != null;
        assert newMap.size() == 2;
    ...
    public void formatJson() {
        ...
        // get formatJson
        String formatJson = JacksonUtil.formatJson(list);
        print(formatJson);
    }
}