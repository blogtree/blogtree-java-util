...
public class FastjsonUtilTest extends BaseTest {

    @Test
    public void toStr() {
        UserPo user = new UserPo(1L, "Michael", 20);
        String result = FastjsonUtil.toStr(user);
        print(result);
        // {"age":20,"id":1,"name":"Michael"}
        assert "{\"age\":20,\"id\":1,\"name\":\"Michael\"}".equals(result);
    }
    ...
    public void toObj() {
        ...
        // get class
        UserPo result = FastjsonUtil.toObj(json, UserPo.class);
        print(result);
        print2Json(result);
        assert result != null;
    ...
    public void toList() {
        ...
        // get json
        String json = FastjsonUtil.toStr(list);
        print(json);
        // [{"age":18,"id":1001,"name":"Ada"},{"age":20,"id":1002,"name":"Leon"}]
        assert "[{\"age\":18,\"id\":1001,\"name\":\"Ada\"},{\"age\":20,\"id\":1002,\"name\":\"Leon\"}]".equals(json);

        // get new list
        List<UserPo> newList = FastjsonUtil.toList(json, UserPo.class);
        print(newList);
        print2Json(newList);
        assert newList != null;
    ...
    public void toMap() {
        ...
        // get json
        String json = FastjsonUtil.toStr(map);
        print(json);
        // {"Ada":18,"Leon":20}
        assert "{\"Ada\":18,\"Leon\":20}".equals(json);

        // get new map
        Map<String, Integer> newMap = FastjsonUtil.toMap(json);
        print(newMap);
        print2Json(newMap);
        assert newMap != null;
        assert newMap.size() == 2;
        assert newMap.get("Ada") != null;
        assert "18".equals(String.valueOf(newMap.get("Ada")));
    }
    ...
    public void toMapWithClass() {
        ...
        String json = FastjsonUtil.toStr(map);
        print(json);
        // {1001:{"age":18,"id":1001,"name":"Ada"},1002:{"age":20,"id":1002,"name":"Leon"}}
        assert "{1001:{\"age\":18,\"id\":1001,\"name\":\"Ada\"},1002:{\"age\":20,\"id\":1002,\"name\":\"Leon\"}}".equals(json);

        // get new map
        Map<String, UserPo> newMap = FastjsonUtil.toMap(json, UserPo.class);
        print(newMap);
        print2Json(newMap);
        assert newMap != null;
        assert newMap.size() == 2;
    ...
    public void formatJson() {
        ...
        // get formatJson
        String formatJson = FastjsonUtil.formatJson(list);
        print(formatJson);
    }
}